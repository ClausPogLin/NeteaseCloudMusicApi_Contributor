...
> [!NOTE]
> Ori : yanranxiaoxi/NeteaseCloudMusicApi(forked from Binaryify/NeteaseCloudMusicApi)
> 本Fork是基于[yanranxiaoxi/NeteaseCloudMusicApi](https://github.com/yanranxiaoxi/NeteaseCloudMusicApi)的复刻,添加了对贡献相关的API支持
